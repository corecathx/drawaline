...
class Button extends FlxSpriteGroup {
    ...
    override function update(elapsed:Float) {
        ...
        if (!enabled) {
            ...
            if (label != null) label.color = labelColorDisabled;
            if (icon != null) icon.color = labelColorDisabled;
            return;
        }

        if (label != null) label.color = FlxColor.WHITE;
        if (icon != null) icon.color = FlxColor.WHITE;
